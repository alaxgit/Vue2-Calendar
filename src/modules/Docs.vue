<template>
  <div id="app">
    <div class="container">
      ...
      <h4>常规使用，单日历，指定可用日期范围，minDate="2017-12-29" maxDate="2019-12-04"</h4>
      <calendar
        v-model="value"
        showDateOnly
        minDate="2017-12-29"
      ...
      <lorem :len="10"></lorem>
      <h4>常规使用，无input文本框 :has-input="false"</h4>
      ...
      <lorem :len="6"></lorem>
      <div class="text-center">Happy 1024!</div>

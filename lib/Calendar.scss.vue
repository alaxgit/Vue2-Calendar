...
@font-face {
  ...
  src: url("./fonts/calendar.eot?8xpf49");
  src: url("./fonts/calendar.eot?8xpf49#iefix")
      format("embedded-opentype"),
    url("./fonts/calendar.ttf?8xpf49") format("truetype"),
    url("./fonts/calendar.woff2?8xpf49") format("woff2"),
    url("./fonts/calendar.woff?8xpf49") format("woff"),
    url("./fonts/calendar.svg?8xpf49#calendar") format("svg");
  font-weight: normal;
  font-style: normal;
}
